...
public class CreateNode {
	...
	public void CreateDrawerFolderforNameduser(String CabinetName, String DrawerName, String FolderName)
		...
		Thread.sleep(3000);
		WebElement element1 = wait.until(ExpectedConditions.elementToBeClickable(CreateDrawerFolder)); 
		...
		WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(CreateNodeOK)); 
