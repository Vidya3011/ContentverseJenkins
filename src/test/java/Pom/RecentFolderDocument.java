...
public class RecentFolderDocument {
	...
	//	RecentDocument.click();
		try {
		WebElement element2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='ownershipMessageModelOk']")));
	...
	Reporter.log("The alert is not present",true);
}
	}
	}
